...
const CACHE_NAME = 'smart-asset-manager-v65'; // [정밀 포트폴리오 리스크 엔진 v3] 벤치마크 다변화(미국
// 종목을 성장/가치 성격별로 나스닥100·다우존스·S&P500에 매핑) + 단기(20일) vs 장기(1년) 변동성 급증
// 감지("⚡ 최근 단기 변동성 급증 경고") + 2022 고금리 기술주 폭락 스트레스 테스트 추가(2020 코로나와
// 나란히 2개 카드로 표시). v64->v65: 이 값을 바꿔야 PWA가 캐시해 둔 예전 index.html을 버리고 새
// index.html을 다시 받아온다 - 안 바꾸면 GitHub에 새 index.html을 올려도 이미 설치된 모바일 PWA는
