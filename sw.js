...
const CACHE_NAME = 'smart-asset-manager-v57'; // [시나리오 카드 - 상대 연차 옆에 캘린더 연도 병기]
// "15년 후"/"20년 후" 라벨에 실제 캘린더 연도를 괄호로 덧붙였다 - "15년 후(2041년) 예상자산"처럼
// CURRENT_YEAR + offset을 그대로 계산해 표시한다(오프셋 자체는 SCENARIO_CARD_YEAR_OFFSETS=[15,20] 고정).
// v56->v57: 이 값을 바꿔야 PWA가 캐시해 둔 예전 index.html을 버리고 새 파일을 다시 받아온다 - 안 바꾸면
