...
const CACHE_NAME = 'smart-asset-manager-v122'; // [종목 분석 모달 - 지표별 초보자용 설명 캡션 추가]
// 이동평균 배열/RSI/볼린저밴드/MDD/베타 각 지표 값 아래에 지금 상태에 맞춘 쉬운 설명을 항상 보이는
// 캡션으로 추가했다(정배열/역배열/혼조, RSI 과열·과매도, 베타 공격형·방어형 등 - maTrendGuideText/
// rsiGuideText/betaGuideText 등, js/10). 호버해야 보이는 툴팁 대신 항상 노출되는 캡션을 택해 모바일
// 에서도 바로 보인다. js/10이 바뀌었으므로 v121->v122로 올려 PWA가 캐시된 예전 버전을 버리고 새로
// 받아오게 한다.
const APP_SHELL = [
  './',
  './index.html',
