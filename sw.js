...
const CACHE_NAME = 'smart-asset-manager-v187'; // [보유 부동산 없으면 안내문구/KPI 줄 자동 숨김] 대시보드
// KPI 카드의 "부동산 자산 총평가금액/투자금액" 두 줄이 보유 부동산이 없으면 항상 "0원"으로 영구히 남던
// 문제를 고쳐, 실제 부동산 보유가 있을 때만 표시되게 했다. 앱 전반(리스크 진단/포트폴리오 구성/포지션
// 비중/실행가이드/미래예측 3개 카드/몬테카를로)의 "부동산 제외" 관련 안내·설명 문구도 같은 기준
// (hasRealEstateHoldings, js/01)으로 보유 부동산이 없으면 해당 언급이 빠진 문장으로 자동 교체된다.
//
