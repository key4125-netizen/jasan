...
const CACHE_NAME = 'smart-asset-manager-v119'; // [종목 분석 & 매크로 브리핑 신규 기능]
// 대시보드에 [🔍 종목 분석 & 투자 검토 보고서] 버튼과 팝업을 새로 추가했고(보유 여부와 무관하게
// 아무 티커나 입력해 이평선 정배열/역배열·RSI·볼린저밴드·MDD·베타·포트폴리오 편입 시뮬레이션까지
// 한 번에 보여줌), RISK 관리 카드 최상단에 VIX/원달러/미10년물/코스피 4대 지표를 보여주는 '시장 현황
// & 매크로 브리핑' 영역을 신설했다. index.html(신규 버튼+모달 마크업)과 js/09,10,11,01,03이 모두
// 바뀌었으므로 v118->v119로 올려 PWA가 캐시된 예전 버전을 버리고 새로 받아오게 한다.
const APP_SHELL = [
  './',
  './index.html',
  './manifest.json',
