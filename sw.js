...
const CACHE_NAME = 'smart-asset-manager-v63'; // [포트폴리오 위험 진단 팝업 '오늘 하루 안 보기' 완전 제거
// (접속/새로고침마다 항상 재노출) + 일간금융평가손익 팝업 기본 조회기간을 6개월->1개월로 변경 + 위험
// 진단 팝업의 '상세 리스크 관리 카드로 이동' 버튼을 모바일에서 줄바꿈되지 않게 문구 단축] v60->v63: 이
// 값을 바꿔야 PWA가 캐시해 둔 예전 index.html을 버리고 새 파일을 다시 받아온다 - 안 바꾸면 GitHub에
