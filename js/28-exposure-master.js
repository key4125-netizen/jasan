...
const EXPOSURE_MASTER_ENTRIES = Object.freeze([
  ...
  { ticker: "AMD", assetType: "FOREIGN_STOCK", assetClass: "US_EQUITY", marketExposure: "US", benchmark: "NASDAQ", priceCcy: "USD", underlyingCcy: "USD", fxExposure: "EXPOSED", conversionMethod: "FX_MULTIPLY", evidence: "KIS 공식 종목마스터(data/ticker-master.json 2026-09-08) exchange=NASDAQ · 미국 거래소 상장(USD 표시) · 본국 보통주 근거: SEC EDGAR 설립지 DE · 연차보고서 10-K(2026-02-04) · 증권 종류 \"Advanced Micro Devices, Inc. - Common Stock\"(nasdaqlisted) · HOME_COMMON_RULE_V1 판정 2026-09-20", equityListing: "HOME_COMMON", evidenceGrade: "A", version: "EM-2026.1" },
  { ticker: "META", assetType: "FOREIGN_STOCK", assetClass: "US_EQUITY", marketExposure: "US", benchmark: "NASDAQ", priceCcy: "USD", underlyingCcy: "USD", fxExposure: "EXPOSED", conversionMethod: "FX_MULTIPLY", evidence: "KIS 공식 종목마스터(data/ticker-master.json 2026-09-08) exchange=NASDAQ · 미국 거래소 상장(USD 표시) · 본국 보통주 근거: SEC EDGAR 설립지 DE · 연차보고서 10-K(2026-01-29) · 증권 종류 \"Meta Platforms, Inc. - Class A Common Stock\"(nasdaqlisted) · HOME_COMMON_RULE_V1 판정 2026-09-20", equityListing: "HOME_COMMON", evidenceGrade: "A", version: "EM-2026.1" },
  { ticker: "TSLA", assetType: "FOREIGN_STOCK", assetClass: "US_EQUITY", marketExposure: "US", benchmark: "NASDAQ", priceCcy: "USD", underlyingCcy: "USD", fxExposure: "EXPOSED", conversionMethod: "FX_MULTIPLY", evidence: "KIS 공식 종목마스터(data/ticker-master.json 2026-09-08) exchange=NASDAQ · 미국 거래소 상장(USD 표시) · 본국 보통주 근거: SEC EDGAR 설립지 TX · 연차보고서 10-K(2026-01-29) · 증권 종류 \"Tesla, Inc.  - Common Stock\"(nasdaqlisted) · HOME_COMMON_RULE_V1 판정 2026-09-20", equityListing: "HOME_COMMON", evidenceGrade: "A", version: "EM-2026.1" },
  { ticker: "NFLX", assetType: "FOREIGN_STOCK", assetClass: "US_EQUITY", marketExposure: "US", benchmark: "NASDAQ", priceCcy: "USD", underlyingCcy: "USD", fxExposure: "EXPOSED", conversionMethod: "FX_MULTIPLY", evidence: "KIS 공식 종목마스터(data/ticker-master.json 2026-09-08) exchange=NASDAQ · 미국 거래소 상장(USD 표시) · 본국 보통주 근거: SEC EDGAR 설립지 DE · 연차보고서 10-K(2026-01-23) · 증권 종류 \"Netflix, Inc. - Common Stock\"(nasdaqlisted) · HOME_COMMON_RULE_V1 판정 2026-09-20", equityListing: "HOME_COMMON", evidenceGrade: "A", version: "EM-2026.1" },
  { ticker: "JPM", assetType: "FOREIGN_STOCK", assetClass: "US_EQUITY", marketExposure: "US", priceCcy: "USD", underlyingCcy: "USD", fxExposure: "EXPOSED", conversionMethod: "FX_MULTIPLY", evidence: "KIS 공식 종목마스터(data/ticker-master.json 2026-09-08) exchange=NYSE · 미국 거래소 상장(USD 표시) · 앱에 NYSE 종합지수 없음 · 본국 보통주 근거: SEC EDGAR 설립지 DE · 연차보고서 10-K(2026-02-13) · 증권 종류 \"JP Morgan Chase & Co. Common Stock\"(otherlisted) · HOME_COMMON_RULE_V1 판정 2026-09-20", equityListing: "HOME_COMMON", evidenceGrade: "A", version: "EM-2026.1" },
  { ticker: "V", assetType: "FOREIGN_STOCK", assetClass: "US_EQUITY", marketExposure: "US", priceCcy: "USD", underlyingCcy: "USD", fxExposure: "EXPOSED", conversionMethod: "FX_MULTIPLY", evidence: "KIS 공식 종목마스터(data/ticker-master.json 2026-09-08) exchange=NYSE · 미국 거래소 상장(USD 표시) · 앱에 NYSE 종합지수 없음 · 본국 보통주 근거: SEC EDGAR 설립지 DE · 연차보고서 10-K(2025-11-06) · 증권 종류 \"Class A Common Stock, par value $0.0001 per share\"(otherlisted) · HOME_COMMON_RULE_V1 판정 2026-09-20", equityListing: "HOME_COMMON", evidenceGrade: "A", version: "EM-2026.1" },
  { ticker: "MA", assetType: "FOREIGN_STOCK", assetClass: "US_EQUITY", marketExposure: "US", priceCcy: "USD", underlyingCcy: "USD", fxExposure: "EXPOSED", conversionMethod: "FX_MULTIPLY", evidence: "KIS 공식 종목마스터(data/ticker-master.json 2026-09-08) exchange=NYSE · 미국 거래소 상장(USD 표시) · 앱에 NYSE 종합지수 없음 · 본국 보통주 근거: SEC EDGAR 설립지 DE · 연차보고서 10-K(2026-02-11) · 증권 종류 \"Mastercard Incorporated Common Stock\"(otherlisted) · HOME_COMMON_RULE_V1 판정 2026-09-20", equityListing: "HOME_COMMON", evidenceGrade: "A", version: "EM-2026.1" },
  { ticker: "JNJ", assetType: "FOREIGN_STOCK", assetClass: "US_EQUITY", marketExposure: "US", priceCcy: "USD", underlyingCcy: "USD", fxExposure: "EXPOSED", conversionMethod: "FX_MULTIPLY", evidence: "KIS 공식 종목마스터(data/ticker-master.json 2026-09-08) exchange=NYSE · 미국 거래소 상장(USD 표시) · 앱에 NYSE 종합지수 없음 · 본국 보통주 근거: SEC EDGAR 설립지 NJ · 연차보고서 10-K(2026-02-11) · 증권 종류 \"Johnson & Johnson Common Stock\"(otherlisted) · HOME_COMMON_RULE_V1 판정 2026-09-20", equityListing: "HOME_COMMON", evidenceGrade: "A", version: "EM-2026.1" },
  { ticker: "UNH", assetType: "FOREIGN_STOCK", assetClass: "US_EQUITY", marketExposure: "US", priceCcy: "USD", underlyingCcy: "USD", fxExposure: "EXPOSED", conversionMethod: "FX_MULTIPLY", evidence: "KIS 공식 종목마스터(data/ticker-master.json 2026-09-08) exchange=NYSE · 미국 거래소 상장(USD 표시) · 앱에 NYSE 종합지수 없음 · 본국 보통주 근거: SEC EDGAR 설립지 DE · 연차보고서 10-K(2026-03-02) · 증권 종류 \"UnitedHealth Group Incorporated Common Stock (DE)\"(otherlisted) · HOME_COMMON_RULE_V1 판정 2026-09-20", equityListing: "HOME_COMMON", evidenceGrade: "A", version: "EM-2026.1" },
  { ticker: "XOM", assetType: "FOREIGN_STOCK", assetClass: "US_EQUITY", marketExposure: "US", priceCcy: "USD", underlyingCcy: "USD", fxExposure: "EXPOSED", conversionMethod: "FX_MULTIPLY", evidence: "KIS 공식 종목마스터(data/ticker-master.json 2026-09-08) exchange=NYSE · 미국 거래소 상장(USD 표시) · 앱에 NYSE 종합지수 없음 · 본국 보통주 근거: SEC EDGAR 설립지 NJ · 연차보고서 10-K(2026-02-18) · 증권 종류 \"Common Stock, without par value\"(otherlisted) · HOME_COMMON_RULE_V1 판정 2026-09-20", equityListing: "HOME_COMMON", evidenceGrade: "A", version: "EM-2026.1" },
  { ticker: "CVX", assetType: "FOREIGN_STOCK", assetClass: "US_EQUITY", marketExposure: "US", priceCcy: "USD", underlyingCcy: "USD", fxExposure: "EXPOSED", conversionMethod: "FX_MULTIPLY", evidence: "KIS 공식 종목마스터(data/ticker-master.json 2026-09-08) exchange=NYSE · 미국 거래소 상장(USD 표시) · 앱에 NYSE 종합지수 없음 · 본국 보통주 근거: SEC EDGAR 설립지 DE · 연차보고서 10-K(2026-02-24) · 증권 종류 \"Chevron Corporation Common Stock\"(otherlisted) · HOME_COMMON_RULE_V1 판정 2026-09-20", equityListing: "HOME_COMMON", evidenceGrade: "A", version: "EM-2026.1" },
  { ticker: "PG", assetType: "FOREIGN_STOCK", assetClass: "US_EQUITY", marketExposure: "US", priceCcy: "USD", underlyingCcy: "USD", fxExposure: "EXPOSED", conversionMethod: "FX_MULTIPLY", evidence: "KIS 공식 종목마스터(data/ticker-master.json 2026-09-08) exchange=NYSE · 미국 거래소 상장(USD 표시) · 앱에 NYSE 종합지수 없음 · 본국 보통주 근거: SEC EDGAR 설립지 OH · 연차보고서 10-K(2026-08-04) · 증권 종류 \"Procter & Gamble Company (The) Common Stock\"(otherlisted) · HOME_COMMON_RULE_V1 판정 2026-09-20", equityListing: "HOME_COMMON", evidenceGrade: "A", version: "EM-2026.1" },
  { ticker: "KO", assetType: "FOREIGN_STOCK", assetClass: "US_EQUITY", marketExposure: "US", priceCcy: "USD", underlyingCcy: "USD", fxExposure: "EXPOSED", conversionMethod: "FX_MULTIPLY", evidence: "KIS 공식 종목마스터(data/ticker-master.json 2026-09-08) exchange=NYSE · 미국 거래소 상장(USD 표시) · 앱에 NYSE 종합지수 없음 · 본국 보통주 근거: SEC EDGAR 설립지 DE · 연차보고서 10-K(2026-02-20) · 증권 종류 \"Coca-Cola Company (The) Common Stock\"(otherlisted) · HOME_COMMON_RULE_V1 판정 2026-09-20", equityListing: "HOME_COMMON", evidenceGrade: "A", version: "EM-2026.1" },
  ...
  { ticker: "472170.KS", assetType: "KR_LISTED_FOREIGN_ETF", exposureStructure: "MIXED", marketExposure: "GLOBAL", priceCcy: "KRW", evidence: "운용사 공식 상품정보(TIGER 미국테크TOP10채권혼합) 기초지수 FnGuide 미국테크TOP10 채권혼합지수(미국 기술주 50% + 국내 국고채 50%) · 2026-09-19 확인 · 운용사 공식 상품정보(TIGER 미국테크TOP10채권혼합) 기초지수 \"FnGuide 미국테크TOP10 채권혼합지수\" = \"Indxx US Tech Top10 지수\" + \"KIS 국채 3-10년(총수익 지수) 지수\" 비중 5:5(2025-10-31부터 4:6에서 변경) · \"환헤지를 하지 아니함\" · 2026-09-20 확인", evidenceGrade: "A", version: "EM-2026.2" },
]);
