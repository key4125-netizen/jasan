...
const EXPOSURE_MASTER_ENTRIES = Object.freeze([
  ...
  { ticker: "QQQM", assetType: "FOREIGN_LISTED_ETF", assetClass: "US_EQUITY", marketExposure: "US", benchmark: "NASDAQ100", priceCcy: "USD", underlyingCcy: "USD", fxExposure: "EXPOSED", hedgeStatus: "UNHEDGED", conversionMethod: "FX_MULTIPLY", evidence: "운용사 공식 상품자료(Invesco NASDAQ 100 ETF · invesco.com 배포 PDF · 2026-07-27 생성 · 2026-09-22 확인) \"Access the Nasdaq-100 Index\" · \"The Invesco NASDAQ 100 ETF (Fund) is based on the NASDAQ-100 Index\". 미국 상장 · USD 표시라 환헤지 개념이 없고 원화 투자자 기준 환노출이다. 운용사 자료에 지수의 PR/TR 표기가 없어 underlyingReturnType은 비워 둔다. 보조 확인: KIS 공식 종목마스터(data/ticker-master.json 2026-09-08) exchange=NASDAQ", evidenceGrade: "A", version: "EM-2026.1" },
  ...
  { ticker: "SPYM", assetType: "FOREIGN_LISTED_ETF", assetClass: "US_EQUITY", marketExposure: "US", benchmark: "SP500", priceCcy: "USD", underlyingCcy: "USD", fxExposure: "EXPOSED", hedgeStatus: "UNHEDGED", conversionMethod: "FX_MULTIPLY", evidence: "운용사 공식 상품 페이지(SPDR Portfolio S&P 500 ETF · ssga.com · 2026-09-22 확인) 벤치마크 \"S&P 500(R) Index\" · 운용목표 \"correspond generally to the total return performance of the S&P 500(R) Index\". 이 문장은 펀드가 지수의 총수익을 따라간다는 운용목표이지 지수 자체의 유형 표기가 아니므로 underlyingReturnType은 비워 둔다. 미국 상장 · USD 표시라 환헤지 개념이 없고 원화 투자자 기준 환노출이다. 보조 확인: KIS 공식 종목마스터(data/ticker-master.json 2026-09-08) exchange=AMEX", evidenceGrade: "A", version: "EM-2026.1" },
